...
void CConsoleSCB::SetupOptionsMenu()
{
    ...
    m_clearConsoleAction = new QAction(tr("Clear Console"), this);
    connect(m_clearConsoleAction, &QAction::triggered, this, &CConsoleSCB::clearConsole);
    m_optionsMenu->addAction(m_clearConsoleAction);
}
