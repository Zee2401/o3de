...
class TkApp(tk.Tk):
    ...
    def __init__(self, config: ConfigData, config_file_path: str = ""):
        ...
        btn_generate.grid()
        _ToolTip(btn_generate, "Generate Android project files (Alt+G)")
    ...
    def _init_load_save_ui(self):
        ...
        _ToolTip(btn_save, "Save current settings to a JSON file (Alt+S)")
    ...
    def _init_sdk_settings_ui(self):
        ...
        _ToolTip(quest_cb, "Enable build settings optimized for Meta Quest VR devices")
