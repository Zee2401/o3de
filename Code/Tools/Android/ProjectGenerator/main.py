...
class TkApp(tk.Tk):
    ...
    def __init__(self, config: ConfigData, config_file_path: str = ""):
        ...
        btn_generate.grid()
        _ToolTip(btn_generate, "Generate the Android Studio project (Alt-G)")
    ...
    def _init_load_save_ui(self):
        ...
        _ToolTip(btn_load, "Load settings from a JSON configuration file (Alt-L)")
        ...
        _ToolTip(btn_save, "Save current settings to a JSON configuration file (Alt-S)")
    ...
    def _init_keystore_settings_ui(self):
        ...
        btn_create.grid()
        _ToolTip(btn_create, "Create a new Android keystore using the details above (Alt-C)")
    ...
    def _init_sdk_settings_ui(self):
        ...
        self._android_quest_flag_var, cb_quest, row_number = self._add_checkbox(sdk_frame, "This is a Meta Quest project", cf.is_meta_quest_project)
        _ToolTip(cb_quest, "Enable configuration and assets specific to Meta Quest devices")
