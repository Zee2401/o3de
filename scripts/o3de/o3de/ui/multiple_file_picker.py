...
class Dialog(object):
    ...
    def __init__(self, parent, file_filters=None, initial_list=""):
        ...
        button_add = tk.Button(button_frame, text="Add", underline=0, width=6, command=self._choose_file)
        button_add.grid(sticky=tk.N)

        button_remove = tk.Button(button_frame, text="Remove", underline=0, width=6, command=self._remove_file)
